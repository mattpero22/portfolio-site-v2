    ...
    return (
        <div id="experience">
            ...
            <div className="education_wrapper">
                <img class="school_logo" src="https://www.cpscentral.com/wp-content/uploads/2016/12/cps-logo-dark.png" alt="consumer priority service logo" />
            ...
            <div className="education_wrapper">
                <img class="school_logo" src="https://i.imgur.com/Of8y0Xy.png" alt="ametek rotron logo" />
                <div className="education_overview">
                    <h2>AMETEK Rotron</h2>
                    <h3>Test Engineer</h3>
