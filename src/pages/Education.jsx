    ...
    return (
        <div id="education">
            ...
            <div className="exp_wrapper">
                ...
                <div className="logo_wrapper">
                    <img class="logo" src="https://www.newpaltz.edu/media/web-assets/logos-images-and-icons/logo_transparent.png" alt="suny new paltz school logo" />
                    <div className="exp_overview">
